...
).pipe(Layer.provide(ProcessRunner.layer), Layer.provide(ServerSettingsLayerLive));
...
const RuntimeCoreDependenciesLive = ReactorLayerLive.pipe(
  ...
  // SpeechLayerLive resolves its own ServerSettings dependency at definition
  // (this pipe sits at its 20-argument limit), and is bundled with
  // OpenCodeRuntime rather than taking a slot of its own.
