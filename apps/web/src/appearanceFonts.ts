...
export const DEFAULT_SANS_FONT_STACK = 'Verdana, Geneva, Tahoma, "DejaVu Sans", sans-serif';
...
export const DEFAULT_CODE_FONT_STACK =
  '"JetBrains Sans", "SF Mono", "SFMono-Regular", "JetBrains Mono", Consolas, "Liberation Mono", Menlo, monospace';
